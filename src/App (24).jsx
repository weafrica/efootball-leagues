                ...
                {canSeePhones && (
                  opp.opponent?.phone ? (
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <WhatsAppLink phone={opp.opponent.phone} text={`Hi, it's ${result.team.name} — ready to set up our matchday ${result.nextFixture.round}?`} c={c} />
                    </div>
              ...
              <div>
                ...
                {canSeePhones && (
                  opp.opponent?.phone ? (
                    <div className="flex items-center gap-2 mt-1">
                      <span className="font-mono text-xs" style={{ color: c.greenText }}>{opp.opponent.phone}</span>
                      <WhatsAppLink phone={opp.opponent.phone} text={`Hi, it's ${result.team.name} — ready to set up our matchday ${result.myFixtures[0].round}?`} c={c} />
                    </div>
                  ) : <div className="font-mono text-xs mt-1" style={{ color: c.textFaint }}>No number on file for this club yet.</div>
                )}
              </div>
